    ...
    <div>
      ...
      <main>
        <div className="p-10 md:p-20 lg:py-60 lg:px-20 ">
          ...
          <Link to="/development/why" className="w-full lg:w-4/12 mb-20 flex flex-col doodle-border">
            <h2 className="text-white mb-10 text-2xl">Why?</h2>
          ...
          <Link to="/development/style" className="w-full lg:w-4/12 mb-20 flex flex-col">
            <h2 className="text-white mb-10 text-2xl">Style</h2>
          ...
          <Link to="/development/process" className="w-full lg:w-4/12 mb-20 flex flex-col">
            <h2 className="text-white mb-10 text-2xl">Process</h2>
          ...
          <Link to="/development/tools" className="w-full lg:w-4/12 mb-20 flex flex-col">
            <h2 className="text-white mb-10 text-2xl">Tools</h2>
