            ...
            <ul>
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                <div className="lg:hidden flex items-center mb-5">
                  ...
                  <span className="text-white font-thin ml-5">Test</span>
                </div>
              ...
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                <div className="lg:hidden flex items-center mb-5">
                  ...
                  <span className="text-white font-thin ml-5">Theme</span>
                </div>
              ...
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                  <div className="lg:hidden flex items-center mb-5">
                    ...
                    <span className="text-white font-thin ml-5">Components</span>
                  </div>
              ...
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                  <div className="lg:hidden flex items-center mb-5">
                    ...
                    <span className="text-white font-thin ml-5">Server</span>
                  </div>
              ...
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                  <div className="lg:hidden flex items-center mb-5">
                    ...
                    <span className="text-white font-thin ml-5">Interfaces</span>
                  </div>
              ...
              <li className="lg:list-disc text-white font-thin mb-20 lg:mb-4">
                  <div className="lg:hidden flex items-center mb-5">
                    ...
                    <span className="text-white font-thin ml-5">Integration</span>
                  </div>
