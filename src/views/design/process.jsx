      ...
      <main>
        <div className="p-10 lg:p-20 lg:py-60 lg:px-20">
          ...
          <div className="w-full lg:w-6/12 mb-20 flex flex-col">
            <h2 className="text-2xl mb-28 lg:mb-10"><s>design</s><span className="ml-5">process</span></h2>
            <div>
              <div className="lg:list-disc  font-thin mb-20 lg:mb-4">
            ...
            <p className=" font-thin mt-10"><i><b className="mr-4"><u>NB</u></b>Depending on a project I follow this is my process chronologically and sometimes I omit some steps.</i></p>
          </div>
